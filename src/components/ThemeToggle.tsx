...
export function ThemeToggle({ theme, onThemeChange, labels }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className="grid size-11 place-items-center bg-transparent text-ink hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent group-data-[theme=dark]:text-zinc-50 group-data-[theme=dark]:hover:text-accent"
    >
